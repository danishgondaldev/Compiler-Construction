...
enum TokenType {
    ...
    T_OR, // for ||
    T_GE, //for >=
    T_FLOAT, //for floating point numbers
        ...
        vector<Token> tokenize() {
            ...
            while (pos < src.size()) {
                ...
                switch (current) {
                        ...
                        //case '<=': tokens.push_back(Token{T_LE, "<="}); break;
                        //case '==': tokens.push_back(Token{T_EQ, "=="}); break;
                        //case '>=': tokens.push_back(Token{T_GE, ">="}); break;
                        //case '&&': tokens.push_back(Token{T_AND, "&&"}); break;
                        //case '||': tokens.push_back(Token{T_OR, "||"}); break;
